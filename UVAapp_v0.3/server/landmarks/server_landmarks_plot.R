#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
plotStatic_LM_plotdata <- reactiveValues()
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    if(input$hide_middle_frame_UI == F){
      ...
      if(is.null(prev_cnt) && !is.null(foll_cnt)){
        ...
        p <- p + scale_linetype_manual(name = "Frames", 
                                       values=c("Middle" = "solid", "Previous" = "dotted", 
                                                "Following" = "dashed"))
      }
    }else{
      ...
      if(is.null(prev_cnt) && !is.null(foll_cnt)){
        ...
        #if there are both previous and following frames
        p <- p + scale_linetype_manual(name = "Frames", 
                                       values=c("Previous" = "dotted", "Following" = "dashed"))
      }
    }
  }else{
    #if there are no extra frames
    ...
    if(!is.null(dbl_clicked_reactive$n)){
      ...
      if(line_point_counter$n == 0){
        ...
        if(first_point$x != x & first_point$y != y){
          ...
          #creates a dataframe to store information on the segment, xy points, 
...
output$landmarksPlot <- downloadHandler(
  filename = function() { paste0('visualisation_LM.', input$saveFormat) },
  content = function(file) {
    
    ggsave(file,plot=plotStatic_LM_plotdata$plot, device = input$saveFormat, 
