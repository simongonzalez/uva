tabPanel("Home",
         ...
         div(style="text-align:center",
             ...
             a('Email: simon.gonzalez@anu.edu.au', 
               ...
               target="_blank"),
             HTML('<li>'),
             a('Citation: Gonzalez, S., (2021) “Gridlines approach for dynamic analysis in speech ultrasound data: A multimodal app”, Laboratory Phonology 22(1). doi: https://doi.org/10.16995/labphon.6463'),
             HTML('<li>'),
